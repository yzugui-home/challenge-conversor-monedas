...
public class VentanaConversorMonedas {
	...
	private void initialize() {
		...
		frmConversorDeDivisas.setTitle("Aplicativo para convertir monedas");
		...
		entradaDivisaOrigen.setToolTipText("Seleccione el tipo de moneda a convertir\n");
		...
		entradaDivisaDestino.setToolTipText("Seleccione a qué moneda desea convertir");
		...
		labelSalida = new JLabel("Bienvenido al conversor de monedas");
		...
		JLabel lblChallengeOne = new JLabel("Conversor de Moneda - Challenge ONE - Java - Back end ");
